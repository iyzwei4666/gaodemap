...
public class OfflineItem implements OnClickListener, OnLongClickListener {
	...
	public OfflineItem(Context context, OfflineMapManager offlineMapManager) {
		mContext = context;
		initView();
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(R.layout.offlinemap_item, null);

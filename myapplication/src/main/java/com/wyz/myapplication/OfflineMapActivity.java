...
import com.wyz.mylibrary.OfflineMapCity;
import com.wyz.mylibrary.OfflineMapManager;
import com.wyz.mylibrary.OfflineMapProvince;
import com.wyz.mylibrary.OfflineMapStatus;
...
public class OfflineMapActivity extends Activity implements
        OfflineMapManager.OfflineMapDownloadListener, OfflineMapManager.OfflineLoadedListener,OnClickListener, OnPageChangeListener {
...
//        MapsInitializer.sdcardDir = "/storage/emulated/0/Download/";
		/*
	...
	private void logList() {
		List<OfflineMapCity> list = amapManager.getDownloadingCityList();
		...
		List<OfflineMapCity> list1 = amapManager
